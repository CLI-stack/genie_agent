...
## Step 1 — Extract RTL Changelist (CL)

For each tile directory, extract the RTL CL before reading any timing data:

1. Read `<tile_dir>/override.params`, find line: `SYN_VF_FILE = <path>`
...
## Step 2 — Find the Tile Directory
