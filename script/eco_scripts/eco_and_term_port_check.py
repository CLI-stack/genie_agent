#!/usr/bin/env python3
"""
eco_and_term_port_check.py — Pre-check script for eco_netlist_studier Step 3.
...
Usage:
    python3 script/eco_and_term_port_check.py \
...
def main():
    ...
    marker_lines = [
        f"ECO_SCRIPT_LAUNCHED: eco_and_term_port_check.py",
